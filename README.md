...
맥북과 CentOS 7, PHP7.x 로 저장을 해 본 결과 한글 및 한자 특수 문자가 잘 저장된다

아래와 같이 특수문자 중.. 하나가 안되는 것이 있는데 .. 파일 이름에 특수문자가 들어가는 경우는 드물므로 에러가 나도 무시한다.

"베리: 롱; 타임^^ 네임* 입니다? 오케이요 ~ 한 352604.png"
